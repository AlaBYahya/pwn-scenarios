...
def main():
    ...
    SOURCE_PRIORITY = ["hackerone.jsonl", "ghsa.jsonl", "zdi.jsonl", "exploitdb.jsonl", "tryhackme.jsonl", "hackthebox.jsonl", "ctf.jsonl", "community_submissions.jsonl", "blogs.jsonl", "pentesterland.jsonl", "curated_lists.jsonl", "rss_feeds.jsonl"]
